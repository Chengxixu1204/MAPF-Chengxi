...
// 	return false;
// }*/
// bool MDD::buildMDD(ConstraintTable& constraint_table, const SingleAgentSolver* _solver, int threshold)
// {
// 	struct Node
// 	{
// 		int location = -1;
...
// 	};
// 	this->solver = _solver;
// 	int goal_location = this->solver->goal_location;  // assuming goal_location is a member of the solver object
// 	//int earliest_timestep = this->solver->earliest_timestep; // assuming earliest_timestep is a member of the solver object
// 	int holding_time = constraint_table.getHoldingTime(goal_location, 0);
