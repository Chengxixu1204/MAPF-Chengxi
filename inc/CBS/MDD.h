...
public:
	...
	bool buildMDD(ConstraintTable& ct, const SingleAgentSolver* solver, int threshold = 1000000000); // build minimal MDD
	//bool buildMDD(ConstraintTable& ct, const SingleAgentSolver* solver); // build minimal MDD
    void buildMDD(const Instance& instance, const vector<int>& distances_to_goal, int start_location);
	//bool buildMDD(ConstraintTable& constraint_table, const SingleAgentSolver* _solver);
	//void buildMDD(const Instance& instance, const vector<int>& distances_to_goal, int start_location);
